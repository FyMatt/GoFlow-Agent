...
func helpCommands() []helpCommand {
	return []helpCommand{
		...
		{Category: "memory", Command: "/memory", Description: "Inspect summary-first project, task, error, solution, file, artifact, and compacted context memory.", Method: http.MethodGet, Path: "/api/memory"},
		{Category: "memory", Command: "/memory search <query>", Description: "Search prompt-retrievable memory; retired learned solutions are skipped by default.", Method: http.MethodGet, Path: "/api/memory/search?q=<query>"},
		{Category: "memory", Command: "/memory solution retire <id>", Description: "Retire a stale learned solution while keeping it auditable.", Method: http.MethodPost, Path: "/api/memory/solutions/{id}/retire"},
		{Category: "memory", Command: "/memory solution supersede <id> --superseded-by <id>", Description: "Retire a stale learned solution and link it to the replacing solution.", Method: http.MethodPost, Path: "/api/memory/solutions/{id}/supersede"},
		{Category: "memory", Command: "/memory solution restore <id>", Description: "Restore a retired learned solution so it can be retrieved into prompts again.", Method: http.MethodPost, Path: "/api/memory/solutions/{id}/restore"},
...
func helpClientContracts() []helpClientContract {
	return []helpClientContract{
		...
		},
		{
			...
			ActionEndpoints:  []string{"GET /api/workflow-runs/{id}/actions", "POST /api/workflow-runs/{id}/retry", "POST /api/workflow-runs/{id}/cancel", "POST /api/workflow-runs/{id}/input", "POST /api/workflow-runs/{id}/approve", "POST /api/workflow-runs/{id}/approve-tool", "POST /api/workflow-runs/{id}/deny-tool", "POST /api/workflow-runs/{id}/approve-tools", "POST /api/workflow-runs/{id}/continue-output", "POST /api/workflow-runs/{id}/approve-budget", "POST /api/workflow-runs/{id}/escalate-model"},
			RequiredBehavior: []string{
