	...
	return []helpClientContract{
		{
			...
			PrimaryEndpoints: []string{"POST /api/run", "GET /api/agent-runs", "GET /api/agent-runs/{id}", "GET /api/agent-runs/{id}/replay", "GET /api/agent-runs/{id}/timeline", "GET /api/agent-runs/{id}/diffs", "GET /api/agent-runs/{id}/export"},
		...
		},
		{
			...
			PrimaryEndpoints: []string{"POST /api/workflows/{name}", "GET /api/workflow-runs", "GET /api/workflow-runs/{id}", "GET /api/workflow-runs/{id}/replay", "GET /api/workflow-runs/{id}/navigation", "GET /api/workflow-runs/{id}/evidence", "GET /api/workflow-runs/{id}/diffs", "GET /api/workflow-runs/{id}/export"},
...
func helpParity() []helpParityItem {
	return []helpParityItem{
		...
		},
		{
			...
			Status:  "implemented",
			Durable: true,
			Notes:   "The unified endpoint is HTTP-only convenience for Studio; item paths point to the typed run APIs and action/action_name filters match currently available backend-discovered actions.",
		},
		{
			Category:   "runtime",
